document.getElementById('Effect').addEventListener('input', function () {
    ...
    inputText = inputText.replace(/\[\]/g, '<span id="spankey" class="image-wrapperfront"><img src="./assets/keywords/nctext.png" alt="Image" class="nctext"></span>');
    inputText = inputText.replace(/\[b\]/g, '<span id="spankey" class="image-wrapperfront"><img src="./assets/keywords/bnctext.png" alt="Image" class="nctext"></span>');
    ...
    inputText = inputText.replace(/attack/g, '<span id="spankey" class="image-wrapper"><img src="./assets/keywords/Attack.png" alt="Image" class="Iskill"></span>');
    inputText = inputText.replace(/desattack/g, '<span id="spankey" class="image-wrapper"><img src="./assets/keywords/Destroy Attack.png" alt="Image" class="Iskill"></span>');
